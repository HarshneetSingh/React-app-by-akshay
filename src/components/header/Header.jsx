...
// const mainLogoo = <NavLink className="flex h-3/4 hover:scale-110 transition duration-200 ease-in-out" to="/"><img src="./SwiggyLogo.jpg" className="h-full" alt="Logo" /></NavLink>
