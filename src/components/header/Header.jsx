...
const mainLogoo = <Link className="flex h-3/4 hover:scale-110 transition duration-200 ease-in-out" to="/"><img src={Logo} className="h-full" alt="Logo.png" /></Link>
...
const linkLogoStyle = `flex  h-full items-center justify-around  relative text-[rgba(61,65,82,1)] w-20 hover:text-headerHoverColor  fill-sortByBtnColor hover:fill-headerHoverColor  `
...
const Header = (props) => {
    return (
        <>
            <div className="w-full h-20 bg-white shadow-[0_15px_40px_-20px_rgba(40,44,63,.15)] fixed top-0 left-0 z-40 " >
