...
const mainLogoo = <Link className="flex h-3/4 " to="/"><img src={Logo} className="h-full" alt="Logo.png" /></Link>
...
const linkObj = [{
    ...
    logo: offerLogo,
    className: `${linkLogoStyle}`,
    className2: `${" after:content-['NEW'] after:absolute after:text-amber-500 after:font-bold after:-top-1 after:-right-6 after:text-[10px]"}`
}, {
    name: "Help",
    logo: helpLogo,
    className: `${linkLogoStyle}`
        ...
        <div className="w-full h-20 bg-white shadow-[0_15px_40px_-20px_rgba(40,44,63,.15)] fixed top-0 left-0 ">
            <div className="w-4/5 h-full m-auto ">
                <div className="flex items-center justify-between w-full  h-full ">
                    ...
                    <div className=" flex justify-between items-center text-[14px]  w-64 h-full leading-[17px] ">
                        {mainLogoo}
                        <div className="  flex justify-between items-center">

                            <div className="font-extrabold  mr-2 text-[#3d4152]  after:content-[' '] after:block after:mt-[2px]  after:h-[2px] after:w-full after:bg-black ">Other</div>
                            <div className="text-[#686b78] mr-2 h-5 font-normal">Chandigarh, India</div>
                            <div><i className="fa-sharp fa-solid fa-angle-down text-orange-400 "></i></div>
                        </div>
                    </div>

                    {/* Links */}

                    <ul className="flex h-full items-center w-2/4 items-align    justify-around font-medium leading-[19px] text-[16px]  ">
                        {
                            linkObj.map((link) => {
                                return (
                                    <Link to={`${link.name}`} key={link.name}  >
