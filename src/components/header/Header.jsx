...
const mainLogoo = <NavLink className="flex h-3/4 hover:scale-110 transition duration-200 ease-in-out" to="/"><img src={require('../../../public/assets/SwiggyLogo.png')} className="h-full" alt="Logo" /></NavLink>
