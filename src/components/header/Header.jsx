...
import SwiggyLogo from "../../../src/assets/SwiggyLogo.webp"
...
const cartLogo = <svg className={`  fill-white `} viewBox="-1 0 37 32" height="18" width="18" ><path d="M4.438 0l-2.598 5.11-1.84 26.124h34.909l-1.906-26.124-2.597-5.11z"></path></svg>

const linkLogoStyle = `flex  h-full items-center justify-around  relative w-20 hover:text-headerHoverColor hover:fill-headerHoverColor  `
...
const Header = (props) => {
    ...
    let helpPage = useLocation()
    helpPage = helpPage.pathname.includes('Help')
    return (
        <>
                ...
                <div className="w-4/5 h-full m-auto ">
                    <div className="flex items-center justify-between w-full  h-full ">
                        ...
                        <div className=" flex justify-between items-center text-[14px]  h-full leading-[17px] ">
                            {mainLogoo}
                            {
                                (helpPage) ? <p className="text-sm m-4 text-sortByBtnHoverColor font-extrabold ">HELP</p> :
                                    <>
                                        <button onClick={() => {
                                            ...
                                            <div className={` flex justify-between items-center h-full [&>*:nth-child(1)]:text-sortByBtnHoverColor [&>*:nth-child(1)]:after:bg-sortByBtnHoverColor [&>*:nth-child(2)]:text-sortByBtnColor  [&>*:nth-child(3)]:text-orange-400  [&>*:nth-child(1)]:hover:text-headerHoverColor [&>*:nth-child(1)]:hover:after:bg-headerHoverColor [&>*:nth-child(2)]:hover:text-[#93959f]`}>
                                                <p className="font-extrabold ml-6  mr-2  after:content-[' '] after:block after:mt-[2px]  after:h-[2px] after:w-full ">{location?.name?.[0]}</p>
                        ...
                        {/* Links */}
                        <ul className="flex h-full items-center w-2/4  justify-between   text-[15px] font-semibold  [&>*:nth-child(5)]:stroke-ttlRestroHeading [&>*:nth-child(5)]:stroke-2 ">
                            {
                                linkObj.map((link) => {
                                    return (
