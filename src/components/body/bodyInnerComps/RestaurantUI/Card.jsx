    ...
    return (
        <div className=" group p-5   pb-0 w-[295px] mr-2 border-transparent border hover:border-[#d3d5df] hover:shadow-[0_4px_7px_0_rgba(218,220,230,.6)] " >
            <div className="relative ">
                <div className="w-full h-40after:content-[' hello']  after:w-full after:h-40  after:absolute after:top-0 after:left-0 after:right-0 after:bottom-0 after:bg-[#282c3f0d] after:bg-blend-overlay">
                    <img src={`${ImgApi}` + `${cloudinaryImageId}`} className="  " alt="" />
                </div>
                {promoted && (
                    <div className="bg-cardHover
                        text-white -left-2 absolute top-0 text-xs font-medium px-2 py-1 after:content-[''] after:absolute  after:border-cardHover after:w-0 after:h-0 after:-bottom-2  after:left-0 after:border-t-8 after:border-r-8  after:border-b-transparent  after:border-b-8  after:border-l-0 ">
                        PROMOTED</div>
                )}
                ...
                <hr />
                {
                    aggregatedDiscountInfo?.shortDescriptionList[0]?.meta && (
                        <div className=" font-normal text-[13px] flex justify-start my-2 text-[#723729] fill-[#8a584b]">
                            {offerLogo}
                            <p className="m-[1px] ml-[3px]">{aggregatedDiscountInfo?.shortDescriptionList[0]?.meta}</p>
                        </div>
                    )
                }
            ...
            <div className="  m-auto text-center invisible  group-hover:visible">
                <hr />
                <button className="text-sky-600 text-sm my-3 hover:text-slate-400 font-semibold">QUICKVIEW</button>
            </div>
        </div>
